...
- [Oromi Agent Services](https://agents.oromi.co.uk) - 19 pay-per-call UK data endpoints for AI agents: Companies House lookups & business-name availability checks, HM Land Registry property price trends & sold prices by postcode, street-level crime context, food hygiene ratings, email/domain/EU-VAT/IBAN verification, web extract & robots.txt checks, and crypto market context. $0.002–$0.05 USDC on Base via CDP facilitator. No API keys, no signup. ([OpenAPI](https://agents.oromi.co.uk/openapi.json)) ([llms.txt](https://agents.oromi.co.uk/llms.txt)) ([Discovery](https://agents.oromi.co.uk/.well-known/x402))
