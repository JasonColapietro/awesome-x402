...
- [x402 Finance API](https://x402-finance-api.onrender.com) — Live, production-tested cryptocurrency price data feed protected by x402. Built with a 30-second cache to shield upstream endpoints. Exact 0.01 USDC on Base Sepolia. Includes [AGENT_GUIDE](https://github.com/lokixc84/x402-finance-api/blob/main/AGENT_GUIDE.md) and [llms.txt](https://github.com/lokixc84/x402-finance-api/blob/main/llms.txt).
