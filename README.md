...
- [x402-signature-service](https://x402-signature-service.onrender.com) - E-signatures for AI agents: send one PDF to one email recipient for simple electronic signature (powered by Documenso), track completion with a one-time bearer token, download the signed PDF. Closes the human-sign-off gap for contract/NDA workflows. $0.50 USDC per request on Base (x402 exact scheme, v1-compatible 402 body), SSRF-guarded document fetching, tokens stored as hashes, no API keys, no signup. ([Schema](https://x402-signature-service.onrender.com/v1/schema)) ([LLM tool](https://x402-signature-service.onrender.com/agent-tool.json)) ([x402scan](https://www.x402scan.com/server/33dd56be-af11-4c8d-b3ee-be502f5307ec)) ([GitHub](https://github.com/paulos-sudo/x402-signature-service))
