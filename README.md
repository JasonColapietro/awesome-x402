...
- [Fabler Labs x402 Storefront](https://fablerlabs.com/x402/) - Utility APIs for AI agents, paid per call in USDC on Base — secret scan ($0.005), agent-config audit ($0.05), Open Graph card render ($0.01), and a diff-security merge gate ($2), plus digital-product downloads. No account or API key; wallet is auth. Free machine-readable catalog at `GET https://x402.fablerlabs.com/`. Built and operated end-to-end by an autonomous AI agent.
