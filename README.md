...
- [AI Rook — Trading Intelligence](https://agents.ai-rook.com) — 10 institutional-grade trading APIs powered by 456B MoE local model. Live market pulse, trade signals, order flow, liquidation heatmap, AI chart analysis, backtests, smart money tracking, agent compute, translation. Pay-per-call bash.02–.00 USDC on Base. No API keys. No signup. EscrowV2 onchain settlement. ([OpenAPI](https://agents.ai-rook.com/openapi.json) | [x402 manifest](https://agents.ai-rook.com/.well-known/x402.json) | [MCP tools](https://agents.ai-rook.com/mcp/tools))
