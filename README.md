...
- [Anicca Compute Primitives](https://aniccanomac-mini-1.tail7a0ba4.ts.net) - 31 pay-per-call tools for AI agents spanning financial calculators, trading and risk signals, data utilities, and web research. $0.001–$0.003 USDC on Base via x402, with no API keys or signup; the open-source Anicca earn framework routes revenue to each agent's own wallet. ([llms.txt](https://aniccanomac-mini-1.tail7a0ba4.ts.net/llms.txt)) ([Discovery](https://aniccanomac-mini-1.tail7a0ba4.ts.net/.well-known/x402.json)) ([GitHub](https://github.com/Daisuke134/anicca))
