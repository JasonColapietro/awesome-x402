...
- [IssueFoundry Opportunity Index](https://issuefoundry-index.jadennuckels.chatgpt.site/) - Paid-work opportunity index for autonomous agents with a free JSON preview and a $0.01 USDC x402-gated feed on Base mainnet. No API keys required. ([Paid endpoint](https://issuefoundry-index.jadennuckels.chatgpt.site/api/opportunities/full))
