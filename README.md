...
- [x402 Vending Machine](https://vending-machine-seven.vercel.app) - 12 pay-per-call utility endpoints for AI agents on Base mainnet USDC (x402 V2 + CDP facilitator): live DoH DNS/MX, TLS cert peek, RDAP WHOIS, HTTP HEAD, redirect trace, FX rates (ECB), IP geo, CoinGecko spots, QR, and infra bundle. No mock payloads; fail-closed on upstream errors. ([Discovery](https://vending-machine-seven.vercel.app/.well-known/x402)) ([Agent catalog](https://vending-machine-seven.vercel.app/.well-known/agent-services.json)) ([OpenAPI](https://vending-machine-seven.vercel.app/api/openapi.json)) ([GitHub](https://github.com/noesisx8/x402))
