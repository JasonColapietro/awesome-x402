...
### Data & Social APIs
- [afriref](https://afriref.dev) - Pan-African government reference data for AI agents: central-bank policy rates, VAT, minimum wages, CPI inflation, corporate & personal income-tax brackets and public holidays for 11 African countries (Nigeria, Kenya, Ghana, Tanzania, Uganda, Rwanda, Egypt, Morocco, Côte d'Ivoire, Senegal, Ethiopia) — every value cited to its official gazette or central-bank source with effective dates and staleness flags. From $0.005 USDC per series call (x402 v2, CDP-facilitated on Base, Bazaar discovery); free catalog and public-holiday endpoints; HMAC-signed change-alert webhooks; computed answers (VAT breakdown, minimum-wage compliance, working days, income tax, gross-to-net payroll); and cross-border VAT determination for digital-services sellers (EU, UK, South Africa), each rule cited to the statute. No API keys, no signup. ([Discovery](https://afriref.dev/.well-known/x402.json)) ([llms.txt](https://afriref.dev/llms.txt))
- [latamref](https://latamref.dev) - Latin American government reference data for AI agents: central-bank policy rates, VAT, minimum wages, CPI inflation, income-tax brackets and public holidays for 12 countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru, Uruguay, Ecuador, Guatemala, Costa Rica, Dominican Republic, Paraguay) — every value cited to its official primary source, honest nulls where no single figure exists (e.g. Argentina's abolished policy rate). Same engine and rails as afriref. From $0.005 USDC per call (x402 v2 on Base); free catalog and public-holiday endpoints. ([Discovery](https://latamref.dev/.well-known/x402.json)) ([llms.txt](https://latamref.dev/llms.txt))
