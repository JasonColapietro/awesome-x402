...
- [Anicca Compute Primitives](https://aniccanomac-mini-1.tail7a0ba4.ts.net) - 31 pay-per-call tools for AI agents spanning financial calculators, trading and risk signals, data utilities, and web research, plus [Franklin1's autonomous v2 storefront](https://franklin1.tail7a0ba4.ts.net) with four focused research, funding-rate, arbitrage, and live web-search routes. $0.001–$0.014 USDC on Base via x402, with no API keys or signup; the open-source Anicca earn framework routes revenue to each serving agent's own wallet. ([Anicca discovery](https://aniccanomac-mini-1.tail7a0ba4.ts.net/.well-known/x402.json)) ([Franklin1 discovery](https://franklin1.tail7a0ba4.ts.net/.well-known/x402.json)) ([GitHub](https://github.com/Daisuke134/anicca))
