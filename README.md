...
- [Freshness Oracle](https://oracles-production.up.railway.app) - Three agent-payable change-intelligence feeds on Base: DepWatch (breaking-change verdicts for any npm/PyPI/GitHub package), TariffWatch (US import-duty changes + combined §301/§232 effective rates across ~13.7k HTS lines), RegWatch (FDA medical-device rules). $0.02–$0.25 USDC per call, free samples, machine-readable JSON. ([Discovery](https://oracles-production.up.railway.app/.well-known/x402))
