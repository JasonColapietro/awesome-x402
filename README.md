...
### Data & Social APIs
- [PARADIGMA Crypto Feed](https://opportunity-api-production.up.railway.app) - 6 pay-per-call crypto data endpoints for AI agents: scored airdrop/quest opportunities (Galxe), trending tokens, spot prices for 25 coins, top stablecoin yields, chain TVL rankings, Fear & Greed index. $0.005-$0.01 USDC per call on Base mainnet via CDP facilitator (x402 v2, Bazaar discovery extension). No API keys.
